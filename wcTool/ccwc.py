...
def main():
    ...
    parser.add_argument('-c', action='store_true', help='Count the number of bytes in the file.')
    parser.add_argument('-l', action='store_true', help='Count the number of lines in the file.')
    parser.add_argument('-m', action='store_true', help='Count the number of characters in the file.')
    parser.add_argument('-w', action='store_true', help='Count the number of words in the file.')

    parser.add_argument('files', nargs='+', type=str, help='Path to the input file(s).')
            ...
            try:
                ...
                if len(tot_result)==0:
                    ...
                    for i in range(0,len(indiv_result)):
                        tot_result[i] = str(int(tot_result[i]) + int(indiv_result[i]))
